  ...
  return (
    <>
      ...
      >
        ...
        {!directed ? ( !settings.showComponents && !settings.showVBCC && !settings.showBridges ? (
          <SettingsToggleSection
            title={
        ...
        {!directed ? ( !settings.showComponents && !settings.showEBCC && !settings.showBridges ? (
          <SettingsToggleSection
            title={
              settings.language == "en"
        ...
        {!directed ? ( !settings.showEBCC && !settings.showVBCC ? (
          <SettingsToggleSection
            title={
              settings.language == "en"
